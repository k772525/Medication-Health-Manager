...
class Config:
    ...
    GOOGLE_APPLICATION_CREDENTIALS = os.environ.get('GOOGLE_APPLICATION_CREDENTIALS', 'cji25.json')
    ...
    def validate_config():
        ...
        # 可選但建議設定的變數
        optional_vars = [
            'SECRET_KEY',  # 如果沒有設定會使用預設值
            'GCS_BUCKET_NAME',  # Kevin 模型圖片上傳功能
            'GOOGLE_APPLICATION_CREDENTIALS'  # GCS 認證
        ]

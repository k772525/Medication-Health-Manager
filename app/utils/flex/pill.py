...
def generate_yolo_result_card_v2_dict(analysis_result: dict, pills_info_from_db: list):
    ...
    return {
        ...
        "hero": {
            "type": "image",
            "url": predict_image_url or "https://scdn.line-apps.com/n/channel_devcenter/img/fx/01_1_cafe.png",
            "size": "full",
            "aspectRatio": "16:9",
            "aspectMode": "cover",
            "action": {"type": "uri", "uri": predict_image_url or "https://scdn.line-apps.com/n/channel_devcenter/img/fx/01_1_cafe.png"}
        },
        # 頭部信息
        "header": {
            "type": "box",
